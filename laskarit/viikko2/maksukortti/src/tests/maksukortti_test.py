...
class TestMaksukortti(unittest.TestCase):
    ...
    #setUp-metodi suoritetaan ennen jokaista testitapausta 
    def setUp(self):
    ...
    def test_Kortilla_ostetaan_edullinen_lounas_kun_kortilla_rahaa_vain_250(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")
        
    def test_Kortilla_ostetaan_maukas_lounas_kun_kortilla_rahaa_vain_400(self):
